---
layout: single
title: Flutter/Dart 핵심만 쏙 - Generic(제네릭) 파헤치기
categories:
  - Dart
tags:
  - [Flutter, Generics]
...
# Flutter/Dart - Generics 제네릭 파헤쳐보기
...
만약 저희가 문자열로만 이뤄진 List을 만들고 싶다면  List<String>이렇게 선언합니다. 그럼 개발자 동료나 Dart Pad가 이 List에는 정수말고 다른 타입으로는 입력할 수 없음을 알 수 있습니다. 여기 예시가 있습니다. 
